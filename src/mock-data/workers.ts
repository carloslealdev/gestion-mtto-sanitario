...
function createEPPDates(lastRenewalDaysAgo: number, monthsUntilRenewal: number): EPPDates {
...
export const workers: Worker[] = [
  // G1
  createWorker("Mario", "González", "V-12345678", "G1", "trabajador-encargado", 5, [
  ...
  createWorker("Luis", "Rodríguez", "V-34567890", "G1", "trabajador-general", 2, [
  ...
  // G2
  createWorker("Carlos", "Leal", "V-56789012", "G2", "trabajador-encargado", 6, [
    { daysAgo: 90, monthsUntil: 3 },
  ...
  // G3
  createWorker("Pedro", "Ramírez", "V-90123456", "G3", "trabajador-encargado", 7, [
  ...
  createWorker("Carmen", "Flores", "V-01234567", "G3", "trabajador-general", 2, [
  ...
  // TN
  createWorker("Roberto", "Castro", "V-33445566", "TN", "trabajador-encargado", 8, [
    { daysAgo: 70, monthsUntil: 3 },
    { daysAgo: 50, monthsUntil: 2 },
    { daysAgo: 90, monthsUntil: 3 },
  ...
  createWorker("Javier", "Morales", "V-44556677", "TN", "trabajador-general", 3, [
  ...
  createWorker("Andrea", "Navarro", "V-55667788", "TN", "trabajador-general", 2, [
    { daysAgo: 25, monthsUntil: 2 },
    { daysAgo: 10, monthsUntil: 1 },
    { daysAgo: 35, monthsUntil: 3 },
    { daysAgo: 15, monthsUntil: 1 },
  ...
  createWorker("Fernando", "Herrera", "V-66778899", "TN", "trabajador-general", 5, [
    { daysAgo: 150, monthsUntil: -1 },
    { daysAgo: 130, monthsUntil: 1 },
