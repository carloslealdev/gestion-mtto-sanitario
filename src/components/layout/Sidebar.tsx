...
const allNavItems: NavItem[] = [
  ...
  {
    to: '/reservas-de-insumos',
    label: 'Reservas para insumos',
    icon: PackagePlus,
    allowedRoles: ['admin', 'encargado'],
  },
  {
    to: '/reservas-de-epps',
    label: 'Reservas para EPPs',
    icon: Shirt,
    allowedRoles: ['admin', 'encargado', 'general'],
  },
  {
    to: '/reportes-tareas-nocturnas',
    label: 'Reportes de Tareas Nocturnas',
    icon: Moon,
    allowedRoles: ['admin', 'encargado'],
  },
];
...
function NavContent({ onNavigate }: { onNavigate?: () => void }) {
  ...
  const filteredNavItems = allNavItems.filter((item) => {
    ...
    return item.allowedRoles.includes(
      role as 'admin' | 'encargado' | 'general',
    );
  });
